...
if (window.location.pathname == "/debu" && (!window.location.href.includes("s4p.vercel.app"))) {
Blockly.ContextMenuRegistry.registry.register({
...
// 👍
// jk no!!
if (window.location.pathname == "/debug" && (!window.location.href.includes("s4p.vercel.app"))) {
    Blockly.ContextMenuRegistry.registry.register({
