<template>
    <b-navbar toggleable="lg" type="dark" style="background-color:#161719;user-select:none;" id="navbar nav-main">
        <b-navbar-brand>
            <img src="S4P.png" width="40" draggable="false">
            S4P
        </b-navbar-brand>
...
export default {
    ...
    mounted(){
        document.getElementById("docName").addEventListener("input", function() {
            document.title = `S4P - ${document.querySelector("#docName").textContent}`;
        }, false);
        ...
        exportToCode(){
            ...
            this.$swal({
                ...
                if(result){
                    ...
                    zip.file("main.py", pythonContent);
                  zip.file("pyproject.toml", `
