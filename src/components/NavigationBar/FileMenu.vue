<template>
     <b-nav-item-dropdown :text="$t('file.title')" right>
        ...
        <input hidden @change="load" id="load-code" type="file" accept=".s4p">
...
export default {
    ...
    methods: {
        ...
        save(){
            ...
            const fileName = `${encodeURIComponent(document.querySelector("#docName").textContent).replace(/%20/g, ' ')}.s4p`;
